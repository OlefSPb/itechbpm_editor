...
namespace NClass.DiagramEditor.ClassDiagram
{
	public sealed partial class DiagramDynamicMenu : DynamicMenu
	{
		...
		private void UpdateTexts()
		{
            ...
            mnuNewFork.Text = Strings.MenuComment;
            ...
            toolNewFork.Text = Strings.AddNewComment;
        ...
        //Fork
        private void mnuNewFork_Click(object sender, EventArgs e)
        {
            if (diagram != null)
                diagram.CreateShape(EntityType.Fork);
        }
