...
namespace NClass.DiagramEditor.ClassDiagram
{
	public class Diagram : Model, IDocument, IEditable, IPrintable
	{
        ...
        //-----------------------------------------------
        //ElementList<Fork> fork = new ElementList<Fork>();
        //-----------------------------------------------
        ...
        //----------ÃÓÈ ÍÓ‰------------------
        Rhombus shapeOutlineR = Rhombus.Empty;
        //-----------------------------------
		...
		public void Display(Graphics g)
		{
			...
			if (state == State.CreatingShape)
			{
               ...
               // } else 
               // {
               //     g.DrawLines(SelectionPen, shapeOutlineR.Apex);
               // }              
			}
		...
		{
			//TODO: ActiveElement.KeyDown() - de nem minden esetben (pl. tˆrlÈsnÈl nem)
			RedrawSuspended = true;
		...
		public void CreateShape(EntityType type)
		{
			...
			switch (type)
			{
                ...
                case EntityType.Fork:
                    shapeOutlineR = ForkShape.GetOutline(Style.CurrentStyle);
                    break;
			}
			shapeOutline.Location = new Point((int) mouseLocation.X, (int) mouseLocation.Y);
            shapeOutlineR.Location = new Point((int)mouseLocation.X, (int)mouseLocation.Y);
			Redraw();
		}
        ...
        //------------------ÃÓÈ ÍÓ‰-----------------------
        protected override void AddFork(Comment comment)
        {
            base.AddFork(comment);
            AddShape(new ForkShape(comment));
        }
